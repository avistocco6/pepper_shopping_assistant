...
add_custom_target(pepper_interface_generate_messages ALL)
...
get_filename_component(_filename "/home/alfonso/Desktop/pepper_shopping_assistant/ROS/src/pepper_interface/srv/PepperRequest.srv" NAME_WE)
add_custom_target(_pepper_interface_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pepper_interface" "/home/alfonso/Desktop/pepper_shopping_assistant/ROS/src/pepper_interface/srv/PepperRequest.srv" ""
)
...
_generate_module_cpp(pepper_interface
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/pepper_interface
  "${ALL_GEN_OUTPUT_FILES_cpp}"
)

add_custom_target(pepper_interface_generate_messages_cpp
...
add_custom_target(pepper_interface_gencpp)
add_dependencies(pepper_interface_gencpp pepper_interface_generate_messages_cpp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS pepper_interface_generate_messages_cpp)
...
### Generating Module File
_generate_module_eus(pepper_interface
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/pepper_interface
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(pepper_interface_generate_messages_eus
...
# target for backward compatibility
add_custom_target(pepper_interface_geneus)
add_dependencies(pepper_interface_geneus pepper_interface_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS pepper_interface_generate_messages_eus)
...
### Generating Module File
_generate_module_lisp(pepper_interface
  ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/pepper_interface
  "${ALL_GEN_OUTPUT_FILES_lisp}"
)

add_custom_target(pepper_interface_generate_messages_lisp
...
# target for backward compatibility
add_custom_target(pepper_interface_genlisp)
add_dependencies(pepper_interface_genlisp pepper_interface_generate_messages_lisp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS pepper_interface_generate_messages_lisp)
...
### Generating Module File
_generate_module_nodejs(pepper_interface
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/pepper_interface
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(pepper_interface_generate_messages_nodejs
...
# target for backward compatibility
add_custom_target(pepper_interface_gennodejs)
add_dependencies(pepper_interface_gennodejs pepper_interface_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS pepper_interface_generate_messages_nodejs)
...
### Generating Module File
_generate_module_py(pepper_interface
  ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pepper_interface
  "${ALL_GEN_OUTPUT_FILES_py}"
)

add_custom_target(pepper_interface_generate_messages_py
...
# target for backward compatibility
add_custom_target(pepper_interface_genpy)
add_dependencies(pepper_interface_genpy pepper_interface_generate_messages_py)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS pepper_interface_generate_messages_py)



if(gencpp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/pepper_interface)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/pepper_interface
    DESTINATION ${gencpp_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_cpp)
  add_dependencies(pepper_interface_generate_messages_cpp std_msgs_generate_messages_cpp)
endif()

if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/pepper_interface)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/pepper_interface
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(pepper_interface_generate_messages_eus std_msgs_generate_messages_eus)
endif()

if(genlisp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/pepper_interface)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/pepper_interface
    DESTINATION ${genlisp_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_lisp)
  add_dependencies(pepper_interface_generate_messages_lisp std_msgs_generate_messages_lisp)
endif()

if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/pepper_interface)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/pepper_interface
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(pepper_interface_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pepper_interface)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pepper_interface\")")
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pepper_interface
    DESTINATION ${genpy_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_py)
  add_dependencies(pepper_interface_generate_messages_py std_msgs_generate_messages_py)
endif()
