...
(cl:defmethod cl:initialize-instance :after ((m <Rest-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rest-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pepper_interface-srv:<Rest-request> is deprecated: use pepper_interface-srv:Rest-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Rest-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rest-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pepper_interface-srv:<Rest-response> is deprecated: use pepper_interface-srv:Rest-response instead.")))
